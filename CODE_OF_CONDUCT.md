...
- Using this project's capabilities against systems or applications without
  proper authorization, or soliciting help doing so
...
reported to the project maintainers via a private message on GitHub, or via
GitHub's private vulnerability/abuse reporting channels if the behavior also
involves a security concern. All complaints will be reviewed and
